...
# Convert_Image_To_Excel_Spreadsheet('image.jpg')
...
print('this tool currently only works with .jpg files, large files may also take long to process/not work entirely')
generateSheet()
